...
module TwilioSegment
  class Analytics
    describe Analytics do
      let(:analytics) { TwilioSegment::Analytics.new :write_key => WRITE_KEY, :stub => true }
      ...
      describe '#respond_to?' do
        it 'responds to all public instance methods of TwilioSegment::Analytics::Client' do
          expect(analytics).to respond_to(*TwilioSegment::Analytics::Client.public_instance_methods(false))
        end
      end

      describe '#method' do
        TwilioSegment::Analytics::Client.public_instance_methods(false).each do |public_method|
